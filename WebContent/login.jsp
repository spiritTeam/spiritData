      ...
      <table width="450px;">
        <tr>
          <td colspan="2" rowspan="1">
	        <input style="width:280px;height:40px;color:#999;font-size: 20px;" class="input_1 required" id="username" name="username"  tabindex="1" type="text" value="支持邮箱/企鹅/手机号" onmouseover=this.focus();this.select();
        ...
        <tr >
          ...
          <tr><td colspan="1" width="170px;"><input style="width:140px;height:40px;color:#999;font-size: 20px;" class="input_1 required" id="checkCode" name="checkCode"  tabindex="3" type="text" value="请输入验证码" onmouseover=this.focus();this.select();
              ...
              <td  align="left"><img title="点击更换" onclick="javascript:refresh(this);" src="check.do"></td></tr>
      </table>
    </form>
  </div>
