...
<center>
  <div style="width:330px;height:400px;">
    <div id="rstDiv" style="text-align:left;margin-left:75px;height:20px;padding-top:20px;"><span id="checkResult"></span></div>
    <form>
      ...
      <div class="" style="margin-top:30px;width:250px;background-image:url(images/bg.png);padding-left:0px;margin-left:-8px;border-radius:5px"><img src="images/next.png"/></div>
