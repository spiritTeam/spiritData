 ...
 * @author wh
 */
public class Dtal0301CException extends DtalCException {
     ...
     * @param message 详细消息
     */
    public Dtal0301CException(String msg) {
     ...
     */
    public Dtal0301CException(Throwable cause) {
     ...
     * @param cause 异常原因，以后通过Throwable.getCause()方法获取它。允许使用null值，指出原因不存在或者是未知的异常
     */
    public Dtal0301CException(String msg, Throwable cause) {
        super(myCode, myBaseMsg, msg, cause);
    }

    public Dtal0301CException(String msg, Throwable cause, boolean enableSuppression,
