...
/**
 * DataAnal检索用户信息失败，内部码为1101，基本信息为'检索用户信息失败'
 * 请参看:
...
public class Dtal1104CException extends DtalCException {
    ...
    private static String myBaseMsg = "检索用户信息失败";
    private static int myCode = 1101;

    /**
     * 构造没有详细消息内容的——'检索用户信息失败'异常
     */
    ...
    /**
     * 根据指定的原因和(cause==null?null:cause.toString())的详细消息构造新——'检索用户信息失败'异常
    ...
    /**
     * 根据指定的原因和(cause==null?null:cause.toString())的详细消息，以及详细消息构造新——'检索用户信息失败'异常
     * @param message 详细消息
     * @param cause 异常原因，以后通过Throwable.getCause()方法获取它。允许使用null值，指出原因不存在或者是未知的异常
     */
