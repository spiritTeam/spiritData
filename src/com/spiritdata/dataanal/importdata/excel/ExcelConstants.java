package com.spiritdata.dataanal.importdata.excel;
...
public abstract class ExcelConstants {
	...
	/** Excel类型，integer [-2147483648,2147483647] */
	public final static int DATA_TYPE_INTEGER = 7;
	/** Excel类型，long [-9223372036854775808,9223372036854775807 ] */
	public final static int DATA_TYPE_LONG = 9;
	/** Excel类型，date */
	...
	public static int convert2DataType(String dtypeStr) {
		if (dtypeStr.equalsIgnoreCase("String"))
			return DATA_TYPE_STRING;
		else if (dtypeStr.equalsIgnoreCase("Numeric"))
			return DATA_TYPE_NUMERIC;
		else if (dtypeStr.equalsIgnoreCase("Double"))
			return DATA_TYPE_DOUBLE;
		else if (dtypeStr.equalsIgnoreCase("Integer"))
			return DATA_TYPE_INTEGER;
		else if (dtypeStr.equalsIgnoreCase("Long"))
			return DATA_TYPE_LONG;
		else if (dtypeStr.equalsIgnoreCase("Boolean"))
			return DATA_TYPE_BOOLEAN;
		else if (dtypeStr.equalsIgnoreCase("Date"))
			return DATA_TYPE_DATE;
		else if (dtypeStr.equalsIgnoreCase("Null"))
			return DATA_TYPE_NULL;
		else if (dtypeStr.equalsIgnoreCase("Error"))
			return DATA_TYPE_ERROR;
		else if (dtypeStr.equalsIgnoreCase("Formula"))
			return DATA_TYPE_FORMULA;
		else
			return -1;
	}
}